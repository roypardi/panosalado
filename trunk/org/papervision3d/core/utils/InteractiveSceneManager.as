		...
		*/		
		...
		public function destroy():void
		{
			...
			//{ 
				...
				container.removeEventListener(MouseEvent.MOUSE_MOVE, handleMouseMove);
			//}
		...
		public function initListeners():void
		{
			if( viewport.interactive )
			{
				...
				container.addEventListener(MouseEvent.CLICK, handleMouseClick); //container.stage.addEventListener(MouseEvent.CLICK, handleMouseClick);
