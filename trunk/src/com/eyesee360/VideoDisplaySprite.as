////////////////////////////////////////////////////////////////////////////////
//
//  EYESEE360 INCORPORATED
//  Based on the VideoDisplay class in the Flex SDK.
//
 ...
 *
 */
public class VideoDisplaySprite extends Sprite
{
    /**
     *  @private
     ...
     *  Constructor.
     */
    public function VideoDisplaySprite()
    {
        super();
    ...
    private var _material:VideoPlayerMaterial = null;

    [Bindable("materialAvailable")]
    
    /**
    *   A PaperVision3D material object that can be used as a surface material for models.
    *   
    */
    public function get material():VideoPlayerMaterial
    {
        return _material;
    } 
    ...
    {
        videoPlayer = new VideoPlayer(1024, 512, _ncManagerClass);
        ...
        _material = new VideoPlayerMaterial(videoPlayer, false);
    }
    ...
    private function resizeVideo():void
    {
        ...
        if (vw > 0 && vh > 0 && videoPlayer.width != vw && videoPlayer.height != vh) {
            // The video width and height have now become available.
            // trace("Resizing video to " + vw + " x " + vh);
            videoPlayer.setSize(vw, vh);
            _material = null;
            _material = new VideoPlayerMaterial(videoPlayer, false);
        }
    }
