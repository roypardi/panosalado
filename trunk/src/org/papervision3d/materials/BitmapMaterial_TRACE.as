		...
		*/
        ...
        protected function renderRec(emMap:Matrix, v0:Vertex3DInstance, v1:Vertex3DInstance, v2:Vertex3DInstance, index:Number):void
        {trace("recursion:", index);
            ...
            if (index >= 100 || (hitRect.width < minimumRenderSize) || (hitRect.height < minimumRenderSize) || (focus == Infinity))
            {
                ...
                tempPreRSD.renderStatistics.triangles++;trace( "first render", index >= 100 , (hitRect.width < minimumRenderSize) , (hitRect.height < minimumRenderSize) , (focus == Infinity) );
                return;
            }
            ...
            if ((dsab > _precision) && (dsca > _precision) && (dsbc > _precision)){
            	...
            	nRss.v1.z = (bz+cz) * 0.5;
          		...
          		nRss.v2.x = mcax * 0.5;
          		nRss.v2.y = mcay * 0.5;
          		nRss.v2.z = (cz+az) * 0.5;trace( "first recursion, greater than precision" );
                renderRec(renderRecMap, v0, nRss.v0, nRss.v2, nIndex);
				
				renderRecMap.tx -=1;trace( "second recursion, greater than precision" );
                renderRec(renderRecMap, nRss.v0, v1, nRss.v1, nIndex);
				
				renderRecMap.ty -=1;
				renderRecMap.tx = emMap.tx*2;trace( "third recursion, greater than precision" );
				...
				renderRecMap.ty = -emMap.ty*2+1;trace( "fourth recursion, greater than precision" );
			...
			nRss.v1.x = mbcx * 0.5;
			nRss.v1.y = mbcy * 0.5;
			nRss.v1.z = (bz+cz)*0.5;trace( "else (d2bc), first recursion" );
