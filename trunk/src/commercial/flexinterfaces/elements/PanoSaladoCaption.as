package commercial.flexinterfaces.elements
{
	...
	public class PanoSaladoCaption extends Text
	{
		...
		protected var globalCaption:String = "";
		
		protected var localCaption:String = "";
		
		internal var __len:int;
		
		public function PanoSaladoCaption()
		{
			super();
			
			styleName = 'PanoSaladoCaption';
		...
		protected function init():void
		{
			...
			globalCaption = (settings.Caption.@label != undefined) ? settings.Caption.@label : "";
		...
		{ 
			...
			localCaption = spacesList.(hasOwnProperty("@id") && @id == spaceLoaded).@label;
			
			this.text = (localCaption != "" && localCaption != null) ? localCaption : globalCaption;
		}
