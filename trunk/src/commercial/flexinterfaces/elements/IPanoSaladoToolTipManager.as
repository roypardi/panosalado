 ...
 */
public interface IPanoSaladoToolTipManager
{
    //--------------------------------------------------------------------------
    //
    //  Properties
	 ...
	 *  @private
	 */
	function registerMouseToolTip(target:DisplayObject, oldToolTip:String,
							 newToolTip:String):void;
	
	/**
	 *  @private
	 */
	function registerDisplayObjectToolTip(target:DisplayObject, oldErrorString:String,
