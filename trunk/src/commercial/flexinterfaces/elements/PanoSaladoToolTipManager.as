 ...
 */
public class PanoSaladoToolTipManager extends EventDispatcher
{
     ...
     */
    private static var implClassDependency:PanoSaladoToolTipManagerImpl;
     ...
     */
    private static var _impl:IPanoSaladoToolTipManager;
     ...
     */
    private static function get impl():IPanoSaladoToolTipManager
    {
        if (!_impl)
        {
            _impl = IPanoSaladoToolTipManager(
                Singleton.getInstance("commercial.flexinterfaces.elements::IPanoSaladoToolTipManager"));
        }
     ...
     *  over the target.
     */
    public static function registerMouseToolTip(target:DisplayObject,
                                                oldToolTip:String,
                                                newToolTip:String):void
    {
        impl.registerMouseToolTip(target, oldToolTip, newToolTip);
    }
     ...
     *  over the target.
     */
    public static function registerDisplayObjectToolTip(target:DisplayObject,
                                                    oldErrorString:String,
                                                    newErrorString:String):void
    {
        impl.registerDisplayObjectToolTip(target, oldErrorString, newErrorString);
    }
     ...
     */
    protected static function sizeTip(toolTip:IToolTip):void
    {
