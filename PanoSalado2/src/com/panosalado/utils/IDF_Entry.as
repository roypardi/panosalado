package com.panosalado.utils {
	...
	public class IDF_Entry {
		...
		public  function writeIDF_Entry(stream:ByteArray, _position:uint, _offset:uint):void {
		...
		public function replaceValues(stream:ByteArray, _values:Object):void {
			if(position_start >= 8){
		...
		public function readIDF_Entry(stream:ByteArray):void {
