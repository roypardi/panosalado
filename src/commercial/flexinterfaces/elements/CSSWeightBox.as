...
include "metadata/AlignStyles.as";
include "metadata/GapStyles.as";
 ...
 */
public class CSSWeightBox extends Container
{
     ...
     *  Constructor.
     */
    public function CSSWeightBox()
    {
        super();

        layoutObject.target = this;
        
       // this.addEventListener(Event.ADDED, hasBeenAdded, false, 0, true);
    }
     ...
     *  @private
     */
    protected var layoutObject:CSSWeightBoxLayout = new CSSWeightBoxLayout();
...
//     public function checkIfThisFitsInParent(event:Event=null):void
//     {
//     	if (this.parent.height < this.height)
//     	{
// 			// scrollbar will be needed
// 			dispatchEvent( new CSSWeightBoxLayoutEvent(CSSWeightBoxLayoutEvent.EXCEEDS_HEIGHT) );
// 		}
// 		else
// 		{
// 			dispatchEvent( new CSSWeightBoxLayoutEvent(CSSWeightBoxLayoutEvent.FITS_IN_HEIGHT) );
// 		}
// 		
// 		if (this.parent.width < this.width)
// 		{
// 			// scrollbar will be needed
// 			dispatchEvent( new CSSWeightBoxLayoutEvent(CSSWeightBoxLayoutEvent.EXCEEDS_WIDTH) );
// 		}
// 		else
// 		{
// 			dispatchEvent( new CSSWeightBoxLayoutEvent(CSSWeightBoxLayoutEvent.FITS_IN_WIDTH) );
// 		}
//     	
//     }
